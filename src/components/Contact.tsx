    ...
    <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
      <div className="flex justify-center items-center">
        <ul className="space-y-4">
            <li className="flex items-center">
                ...
                />
                <p className="text-xl">+33 6 26 13 84 78</p>
            </li>
            <li className="flex items-center">
                <Image 
                    src={mail}
                    ...
                    className='h-[110px] w-auto mr-6'
                />
                <p className="text-xl">abdessamad.ajja00@gmail.com</p>
            </li>
        </ul>
      </div>
      <div className="bg-white/10 p-6 rounded-xl max-w-[550px]">
        ...
        <form className="space-y-4" action="https://getform.io/f/anlerzra" method='POST'>
            ...
            <textarea name='text' placeholder='Your Message' className="bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400 w-full" />
            <button className='bg-orange-700 hover:bg-orange-500 text-white px-6 py-2 w-full font-semibold text-xl rounded-xl' type='submit'>Send Message</button>
        </form>
      </div>
    </div>
  )
