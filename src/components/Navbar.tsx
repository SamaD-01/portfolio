...
const navlinks = [
    ...
    { title: "Playground Lab", path: "http://playgroundlab.samad.tech/" }
];
...
const Navbar = () => {
    ...
    return (
        <div className="text-white/70 bg-black/90">
            ...
            <div onClick={toggleNav} className="md:hidden absolute top-5 right-5 border rounded text-white border-white/70 p-2 z-50">
